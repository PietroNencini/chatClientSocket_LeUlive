...
public class Utils {
    ...
    /**
     * A livello client viene controllato che il messaggio e il suo destinatario non siano stringhe vuote. Per tutti gli altri controlli sulla validità del messaggio inserito se ne occupa il server
     * @param receiver destinatario del messaggio
     * @param text testo del messaggio
     * @return -1 se il destinatario è vuoto. -2 se il testo del messaggio è vuoto. 0 se va tutto bene
     */
